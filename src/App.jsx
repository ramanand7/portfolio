  ...
  return (
    <div className="bg-gray-900 text-white overflow-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div
          className="absolute w-96 h-96 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full blur-3xl transition-all duration-500 ease-out pointer-events-none"
          style={{
        ...
        />
        {/* Floating particles */}
        <div className="absolute top-20 left-20 w-2 h-2 bg-blue-400 rounded-full animate-pulse pointer-events-none" />
        <div className="absolute top-40 right-32 w-1 h-1 bg-purple-400 rounded-full animate-ping pointer-events-none" />
        <div className="absolute bottom-32 left-1/4 w-1.5 h-1.5 bg-green-400 rounded-full animate-bounce pointer-events-none" />
        <div className="absolute top-1/2 right-1/4 w-1 h-1 bg-yellow-400 rounded-full animate-pulse pointer-events-none" />
      </div>

      {/* Main content wrapper for stacking context */}
          ...
          <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
            ...
            <AnimatedCard delay={400}>
              ...
              <p className="text-lg text-gray-400 mb-8 max-w-3xl mx-auto">
                Crafting exceptional mobile experiences with 3+ years of expertise in Flutter, Node.js & enterprise solutions
              </p>
            </AnimatedCard>
            ...
            <AnimatedCard delay={800}>
              <div className="flex justify-center flex-wrap gap-4 mb-8">
                ...
                <button
                  className="border border-gray-600 px-8 py-4 rounded-full hover:bg-gray-800 transition-all duration-300 flex items-center space-x-2"
                  onClick={() => {
                    window.open('https://drive.google.com/uc?export=download&id=1MgltyZnst5tz-bvxe6lt2RCq-otKsmXW', '_blank');
                  }}
                >
              ...
              <AnimatedCard delay={200}>
                <div className="relative">
                  <img
                    src={myPhoto}
                    alt="Ramanand Sharma"
                    className="w-80 h-80 mx-auto rounded-3xl object-cover border border-gray-700/50"
                  />
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-lg text-gray-300 leading-relaxed mb-4">
                      ...
                      and backend technologies. I have completed my B.Tech in Information Technology from Delhi Technological University
                      with a CGPA of 8.4/10.
                    </p>

                    <p className="text-lg text-gray-300 leading-relaxed mb-6">
                      With 3+ years of professional experience, I've successfully delivered multiple cross-platform applications
        ...
        <Section id="contact" className="py-20 relative">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start relative z-10">
              ...
              <AnimatedCard delay={400}>
                <div className="bg-gray-800/30 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-8 relative z-10">
                  ...
                  <form className="space-y-6" onSubmit={handleFormSubmit}>
                    ...
                    {formStatus && (
                      <div className="text-center text-sm text-green-400">{formStatus}</div>
                    )}
                    <button
                      type="submit"
